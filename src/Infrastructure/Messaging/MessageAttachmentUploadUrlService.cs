...
public sealed class MessageAttachmentUploadUrlService : IMessageAttachmentUploadUrlService
{
    private readonly MessageAttachmentUploadOptions _options;

    public MessageAttachmentUploadUrlService(IOptions<MessageAttachmentUploadOptions> options)
    {
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        string objectKey = $"messages/{threadId:D}/{userId:D}/{Guid.CreateVersion7():D}{extension}";
