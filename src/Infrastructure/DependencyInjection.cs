...
public static class DependencyInjection
{
    public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddScoped<IPublicTenantRepository, NpgsqlPublicTenantRepository>();
        services.Configure<TenantBrandingStorageOptions>(configuration.GetSection(TenantBrandingStorageOptions.SectionName));
        services.AddSingleton<ITenantBrandingUploadUrlService, TenantBrandingUploadUrlService>();
        ...
        services.AddSingleton<IPaymentGatewayWebhookVerifier, NoopPaymentGatewayWebhookVerifier>();
        ...
        services.AddScoped<IStaffInvitationTokenStore, NpgsqlStaffInvitationTokenStore>();
        services.Configure<StaffInvitationLinkFactoryOptions>(configuration.GetSection(StaffInvitationLinkFactoryOptions.SectionName));
        services.AddScoped<IStaffInvitationLinkFactory, StaffInvitationLinkFactory>();
